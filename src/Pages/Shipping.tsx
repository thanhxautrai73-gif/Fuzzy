    ...
    <div className="text-start">
          ...
          <section>
            <div className="custom-container">
                    ...
                    <div className="shipping-details">
                      ...
                      <div className="price">
                        <div className="form-check form-check-reverse">
                          ...
                          <input className="form-check-input" type="radio" name="exampleRadio" id="radio2" defaultValue="option2" checked />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <Link to="/checkout" className="btn theme-btn w-100 shipping">apply</Link>
            </div>
          </section>
